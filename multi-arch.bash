...
get_busybox() {
	...
	arm64)
		echo 'https://hub.fastgit.org/docker-library/busybox/raw/dist-arm64v8/stable/glibc/busybox.tar.xz'
	;;
	*)
		echo 'https://hub.fastgit.org/docker-library/busybox/raw/dist-amd64/stable/glibc/busybox.tar.xz'
	;;
	esac
}
